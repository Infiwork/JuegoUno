...
public class ScreenLoading extends AbstractScreen {
    ...
    public void show() {
        ...
        game.manager.load("boton_1.png", Texture.class);
        game.manager.load("boton_2.png", Texture.class);
        game.manager.load("boton_3.png", Texture.class);
        game.manager.load("audio/background_menu.ogg",Music.class);
        //Assets for Game
        ...
        game.manager.load("alert.png", Texture.class);
